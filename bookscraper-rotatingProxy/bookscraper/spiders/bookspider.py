...
class BookspiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
     ...
     #  Pagination Logic
        ...
        #     yield response.follow(url=get_proxy_url(next_page_url), callback=self.parse, headers={"User-Agent": self.user_agent_list[random.randint(0, len(self.user_agent_list)-1)]})
