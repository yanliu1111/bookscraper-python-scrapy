...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):        
        ...
        if 'sec-fetch-mod' in random_browser_header:
            ...
            spider.logger.warning("'sec-fetch-mod' key is missing in random_browser_header")
        ...
        if 'sec-ch-ua-platform' in random_browser_header:
            ...
            spider.logger.warning("'sec-ch-ua-platform' key is missing in random_browser_header")
